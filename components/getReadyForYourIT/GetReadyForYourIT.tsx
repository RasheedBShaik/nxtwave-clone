...
import PlacementAssistanceForYourJob from "./steps/PlacementAssistanceForYourJob";

const left = [
  {
    title: "Get Ready for Your IT Career in 3 Steps",
    content: "but",
  },
];
...
const items = [
  ...
  {
    title: "Choose Your Job Track",
    content: <ChooseYourJobTack />,
  },
  {
    title: "Placement Assistance For Your Job",
    content: <PlacementAssistanceForYourJob />,
  },
];

// Styled flex wrapper for responsive layout
      ...
      <FlexWrapper>
        <StepColumn className="text-base font-normal">
          <div className="sticky top-0 py-10">
            <h2 className="text-5xl font-bold md:px-4 md:text-left">
              ...
              <span className="relative inline-block">
                ...
                <svg
                  ...
                  className="absolute left-0 -bottom-3 w-full h-3 fill-current text-[#7c3aed]"
                >
            ...
            <div className="mt-22 flex justify-center md:justify-start gap-5 md:px-4">
        ...
        <StepColumn className="text-base mx-auto">
          <Steps
...
export default GetReadyForYourIT;
